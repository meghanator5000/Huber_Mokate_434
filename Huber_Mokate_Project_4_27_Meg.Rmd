...
#   print(end_year)
# 
#   decade_tb <- bls_api(seriesid = bls_seriesid,
#                                startyear = as.character(start_year),
#                                endyear = as.character(end_year))
# 
#   if (i != 1) {
#     inflation_tb <- bind_rows(inflation_tb, decade_tb)
#   } else {
#     inflation_tb <- decade_tb
#   }
# }

# write_csv(inflation_tb, "Inflation_Dataset")
...
>>>>>>> 860ab9724fdcd26c5f79ff432736fc01f74c8256
