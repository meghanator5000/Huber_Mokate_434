...
This short analysis exposes some real issue with the current value of minimum wage in 2021, providing further evidence for those arguing that the minimum wage has some serious room to increase given overall economic growth. If a rising tide does indeed lift all boats, the current US economic system has left minimum wage earners behind and it is time to make some significant adjustments.
