...
### Decades: Change in minimum wage values by decade for raw minimum wage and GDP Projected minimum wage
```{r}
...
### Decades_2: Change in minimum wage values by decade for raw minimum wage, purchasing power of minimum wage, and GDP Projected minimum wage
```{r}
...
3. decades = includes column for proportional differences in raw minimum wage and GDP Projected minimum wage from start to end of decade
...
8. decades_2 = includes column for proportional differences in raw minimum wage, GDP Projected minimum wage, and purchasing power of minimum wage from start to end of decade
...
#### Decades
We perform exploratory analysis in Decades and Decades_1 before performing final, explanatory analysis in the Decades_2 table and graph.
